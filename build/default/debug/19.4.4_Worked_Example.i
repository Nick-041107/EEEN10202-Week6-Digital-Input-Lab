# 1 "19.4.4_Worked_Example.s"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 286 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "19.4.4_Worked_Example.s" 2
processor 18F8722
radix dec
...
PSECT start, class=CODE, reloc=2
    start:
    ;Use Port C, F, H, Q3(((PORTA) and 0FFh), 4, a), Set Digital Mode
    ;LED 1
    ;((PORTA) and 0FFh), 4, a 1
    movlw 00111100B
    movwf TRISC, a
    clrf TRISF, a
