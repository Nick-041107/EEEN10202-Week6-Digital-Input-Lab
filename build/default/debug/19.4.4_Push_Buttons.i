# 1 "19.4.4_Push_Buttons.s"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 286 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "19.4.4_Push_Buttons.s" 2
processor 18F8722
radix dec
...
PSECT start, class=CODE, reloc=2
    start:
    ;Use Port F,B,and J, Q3(((PORTA) and 0FFh), 4, a),Set digital Mode
    ; ((PORTA) and 0FFh), 4, a 1, LED 1
    clrf TRISF, a
    movlw 00000001B
    movwf TRISB, a
    movlw 11101111B
